console.log("მოგესალმებათ სანდრო");
...
// Function ბრუნის და თამაშის დაწების
const changeTurn = () => {
  return turn === "X" ? "0" : "X";
};

// Function მოგების შესამოწმებლად
const checkWin = () => {
...
reset.addEventListener("click", () => {
  ...
  document.getElementsByClassName("info")[0].innerText = "პოზიცია " + turn;
